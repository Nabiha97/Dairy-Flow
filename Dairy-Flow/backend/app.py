...
def api_root():
    return '''
    <h1> Dairy-Flow API v1.0</h1>
    <p>✅ Backend running successfully!</p>
    <h3>Available Endpoints:</h3>
    <ul>
        <li><a href="/api/production">/api/production</a> - Buffalo milk production</li>
        <li><a href="/api/sales">/api/sales</a> - Customer sales</li>
        <li><a href="/api/purchases">/api/purchases</a> - Supplier purchases</li>
        <li><a href="/api/expenses">/api/expenses</a> - Expenses</li>
        <li><a href="/api/salaries">/api/salaries</a> - Employee salaries</li>
        <li><a href="/api/health">/api/health</a> - Health check</li>
    </ul>
    <p><strong>ngrok:</strong> https://unofficially-mushroomy-veta.ngrok-free.dev</p>
    '''
